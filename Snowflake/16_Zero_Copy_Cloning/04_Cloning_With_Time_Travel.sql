...
// Using time travel
SELECT * FROM OUR_FIRST_DB.public.time_travel before (statement => '01aef19b-0004-bdad-0000-ab730001b0b2');



// Using time travel
CREATE OR REPLACE TABLE OUR_FIRST_DB.PUBLIC.time_travel_clone
CLONE OUR_FIRST_DB.public.time_travel before (statement => '01aef19b-0004-bdad-0000-ab730001b0b2');
...
SELECT * FROM OUR_FIRST_DB.public.time_travel_clone before (statement => '01aef19b-0004-bdad-0000-ab730001b0b2');

CREATE OR REPLACE TABLE OUR_FIRST_DB.PUBLIC.time_travel_clone_of_clone
CLONE OUR_FIRST_DB.public.time_travel_clone before (statement => '01aef19b-0004-bdad-0000-ab730001b0b2');
