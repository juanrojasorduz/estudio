...
SELECT * FROM OUR_FIRST_DB.public.customers before (statement => '01aeecbc-0004-bd19-0000-ab7300015682');


SELECT * FROM OUR_FIRST_DB.public.customers;

UNDROP table OUR_FIRST_DB.public.customers; -- This undrop the table that we drop with the create or replace table

-- Because the table already exists, we hace to rename to another table and the we can undrop it
